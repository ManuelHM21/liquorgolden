...
import { useCarrito } from "./ContextoNav.js";
                  ...
                  <div className="flex flex-col justify-between m-3">
                    ...
                    <div className="mt-4 flex justify-center">
                      {product.stock > 2 ? (
                        ...
                        <button
                          type="submit"
                          className="flex w-full justify-center rounded-md bg-black bg-opacity-30 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
